...
df_indicadores = pd.read_excel("Base_ActualizacionMayo2022.xlsx", sheet_name='mapa')

df_capa2 = pd.read_excel("Base_ActualizacionMayo2022.xlsx", sheet_name='mapa')
...
def acciones(df_in):
    for row in df_in.itertuples():
        ...
        popup = folium.Popup(html=contenido, max_width='600')
