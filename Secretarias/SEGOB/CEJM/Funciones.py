...
def tarjeta_dos(row):
    ...
    VIDEOS = [str(row.VIDEO1), str(row.VIDEO2), str(row.VIDEO3), str(row.VIDEO4),str(row.VIDEO4)]
    ...
    texto = """
        <article class="popup" style="background-color:#900C3F; margin: 0px; font-family:sans-serif; font-size:11px;border-radius: 20px; padding=5px;">
            <div class="card-body">
                ...
                <p style="color:#FFFFFF; margin: 0px;"><i class="fa fa-calendar" style = "color:#FAC63A;"></i><strong> ACCIONES: </strong>""" + str(row.TRIMESTRE) + """</p>
                ...
                <p style="color:#FFFFFF; margin: 0px;"><i class="fa fa-bar-chart" style = "color:#FAC63A;"></i><strong> APOYOS: </strong>"""+ str(row.APOYOS) +""" </p>
