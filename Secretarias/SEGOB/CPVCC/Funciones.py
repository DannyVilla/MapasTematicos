...
def genera_contenido(MUNICIPIO, FECHA, TIPO, EVENTO, FOTO1, FOTO2, VIDEO):
    FOTOS = [FOTO1, FOTO2]
    texto = """
        <article class="popup" style="background-color:#900C3F; margin: 0px; font-family:sans-serif; font-size:11px;border-radius: 20px; padding=5px;">
            <div class="card-body">
                ...
                <p style="color:#FFFFFF; margin: 0px;"><i class="fa fa-list" style = "color:#FAC63A;"></i><strong> TIPO: </strong>""" + TIPO +"""</p>
                <p style="color:#FFFFFF; margin: 0px;"><i class="fa fa-check-circle" style = "color:#FAC63A;"></i><strong> EVENTO: </strong>""" + EVENTO +"""</p>
        """
    ...
    texto += """            
                <div align = "center">
                    <p style="margin: 0px;color:white">Más información: </p> """ + genera_rs("CPVCC") + """
                </div>
            </div>
        </article>
    """
