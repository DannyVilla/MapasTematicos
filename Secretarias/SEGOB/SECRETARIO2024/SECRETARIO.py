...
df_secretario_2023 = pd.read_excel("SECRETARIO_OK.xlsx", sheet_name='SECRETARIO_2023-2024')
...
layer_Apoyo_2023=FeatureGroup(name='Apoyo a Ciudadanía',show=False)
layer_Gobernabilidad_2023=FeatureGroup(name='Gobernabilidad (Acuerdos, programas, entre otros)',show=False)
layer_Promocion_2023=FeatureGroup(name='Promociones Turisticas',show=False)
layer_Mesas_2023=FeatureGroup(name='Mesas Coordinación de la Paz',show=False)
