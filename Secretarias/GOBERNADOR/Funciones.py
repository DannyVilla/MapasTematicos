...
def content_gobernador(MUNICIPIO, TEXTO, FECHA, CLASIFICACION, FOTO, PUB):
    texto = """
    ...
    texto += """
                                <div align = "center">
                                     <p style= "margin:0px;color:white;">Más información: </p> """ + genera_rs("GOBERNADOR") + """
                                </div>
                        </div>
                    </div>
                </article>
...
def content_gobernador_2023(MUNICIPIO, TEXTO, FECHA, URL, CLASIFICACION, FOTO, PUB):
    texto = """
        <article class="popup" style="background-color:#900C3F; margin: 0px; font-family:sans-serif; font-size:11px;border-radius: 20px; padding=5px;">
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
